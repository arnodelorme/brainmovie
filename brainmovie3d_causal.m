...
%
% brainmovie3d_causal( ersps, itcs, crossfs_amp, crossfs_phase, times, freqs, [1:2], 'coordinates', [ EEG.dipfit.model(1).posxyz; EEG.dipfit.model(2).posxyz ] );
%
...
try, g.Layers;              catch, g.Layers = struct([]); end % mesh to plot
